...
var core = {
    ...
    checkStatus: function(server, service, callback) {
        var self = this;
        ...
        function runCommand(server) {
            var cmd = 'bender --log debug --server ' + server.id + ' --command status --service ' + service.id;
    ...
    _execSshCommand: function(options, callback) {
        ...
        function end(ret) {
            ...
            self.log.verbose('Handling Command Callback for Command: ' + options.command, ret);
