...
exports.Server = {
   whitelistServer: function(iface, privateOnly) {
       ...
       iptables.newRule({ chain: 'INPUT', target: 'DROP', action: '-P'});
       iptables.newRule({ chain: 'FORWARD', target: 'DROP', action: '-P'});
       iptables.newRule({ chain: 'OUTPUT', target: 'ACCEPT', action: '-P'});
