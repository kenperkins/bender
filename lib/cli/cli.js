...
var CommandLine = exports.CommandLine = function(config) {
    ...
    self.app
        ...
        .option('--update <configPath>', 'Update bender on all servers, with the supplied path for the config')
    ...
    if (self.app.resetDatabase) {
        ...
        self.initialize(function() {
            self.updateServers(self.app.update);
        });
    }
