    ...
    createServer: function() {
        ...
        async.series([
            ...
            function(callback) {
                ...
                self.bender.rackspace.getServices(function(err, services) {
                    ...
                    function addService() {
                        ...
                        self.app.choose(serviceOptions, function(i) {
                            var service = serviceOptions.splice(i);
                            ...
                            for (var j = 0; j < services.length; j++) {
                                if (service === services[j].name) {
                                    options.services = services[j].splice;
                                }
                            }
