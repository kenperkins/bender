                            ...
                            async.forEachSeries(servers, function(server, next) {
                                ...
                                async.series([
                                    ...
                                    function(asyncCallback) {
                                        ...
                                        function swapPools(loadBalancerId, swapIn, swapOut, reloadOnCompletion, callback) {
                                            console.log('Starting to rotate servers with reload=' + reloadOnCompletion);

                                            console.log('Swapping in');
                                            console.dir(_.map(swapIn, function(appServer) {
                                                return appServer.server.name;
                                            }));

                                            console.log('Swapping out');
                                            console.dir(_.map(swapOut, function(appServer) {
                                                return appServer.server.name;
                                            }));
                                            ...
                                            async.forEachSeries(
                                                ...
                                                function(appServer, callback) {
                                                    console.log('Initiate swapout ' + appServer.server.getFriendlyLabel());
                                                ...
                                                function(err) {
                                                    ...
                                                    async.forEachSeries(
                                                        swapIn,
                                                        function(appServer, callback) {
                                                            console.log('Initiate swapin ' + appServer.server.getFriendlyLabel());
                                                            self.bender.execServerCommand(
                                                                loadBalancerId, 'swapin-' + appServer.server.id, function(err) {
                                                                    if (err) {
                                                        ...
                                                        function(err) {
                                                            ...
                                                            if (reloadOnCompletion) {
                                                                console.log('Initiating reload on ' + loadBalancerId);
                                                                self.bender.execServiceCommand(
                                                                    loadBalancerId, 'nginx', 'reload', function(err) {
                                                                        //TODO: Log
                                                                        callback(err);
                                                                    }
                                                                );
                                        ...
                                        swapPools(loadBalancerId, [], poolA, true, function(err) {
                                            if (err) {
                                                asyncCallback(err);
                                                return;
                                            }
                                            ...
                                            async.forEach(
                                                ...
                                                function(appServer, callback) {
                                                    deployServer(appServer, true, function(err) {
                                                        ...
                                                        swapPools(loadBalancerId, poolA, poolB, true, function(err) {
                                                            if (err) {
                                                                //TODO: Log
                                                                callback(err);
                                                                return;
                                                            ...
                                                            async.forEach(
                                                                ...
                                                                function(appServer, callback) {
                                                                    deployServer(appServer, true, function(err) {
                                                                        ...
                                                                        // swap back in poolB
                                                                        swapPools(loadBalancerId, poolB, [], true, function(err) {
                                                                            callback(err);
                                                                        });
                                                                    });
                                                                },
            ...
            rsync.execute(function(err, stdout, stderr) {
                if (err) {
                    ...
                    if (restartAfterDeploy) {
                        console.log('Restarting ' + target.service.name + ' on ' + target.server.name);
                        self.bender.execServiceCommand(
                            target.server,
                            target.service,
